...
// --- GERAR 2ª VIA (ATUALIZADA COM EXUMAÇÃO) ---
function gerar2ViaPublica() {
    ...
    // --- CÁLCULO DA DATA DE EXUMAÇÃO (IGUAL AO ADMIN) ---
    let dataExumacao = "";
    if (d.data_ficha) {
