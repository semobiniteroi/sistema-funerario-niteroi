        ...
        if(doc.exists) {
            ...
            if (mapContainer && mapFrame && mapLink) { 
                ...
                if (cleanCoords && cleanCoords.includes(',')) { 
                    ...
                    mapFrame.innerHTML = `<iframe width="100%" height="100%" frameborder="0" style="border:0" src="https://www.google.com/maps?q=${cleanCoords}&output=embed"></iframe>`; 
